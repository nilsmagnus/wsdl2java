...
This plugin is forked from deprecated nilsmagnus/wsdl2java. Version 2.1.1 only includes a small update to make the plugin compatible with Gradle 7+. 
...
plugins {
  id 'java'
  classpath 'com.yupzip:wsdl2java:2.1.1'
}
```
...
plugins {
    id("java")
    id("com.yupzip.wsdl2java") version "2.1.1"
}
```
