...
Apache CXF supports [extensions for xjc](http://confluence.highsource.org/display/J2B/JAXB2+Basics+Plugins), e.g. for creating a hashCode, equals and toString method in the classes generated by xjc.

To use those extension some more dependencies are necessary. 

    dependencies() {
        testCompile 'junit:junit:+'

        // used in the generated classes
